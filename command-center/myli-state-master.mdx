...
| [AI Programming](/legacy/guides/ai-programming) | **the LANGUAGE** — the prompt registry, per-lane prompt assembly, the working memory composer | where a prompt lives · how the voice/text/email prompt is built |
...
**This page and [AI Programming](/legacy/guides/ai-programming) split on Zach's own doctrine —
...
⚠ **But the AI Programming page has drifted, and it should be fixed rather than worked around.** It
carries a **legacy / unverified** banner, its last update is **July 23**, and:
